...
function tm_open_shop_content_wrappers(){
	if ( is_singular( 'product' ) ) {
		get_template_part( 'woocommerce/tm-open-wrapper-single-product' );
	} else {
		get_template_part( 'woocommerce/tm-open-wrapper' );
	}
}
function tm_close_shop_content_wrappers(){
	if ( is_singular( 'product' ) ) {
		get_template_part( 'woocommerce/tm-close-wrapper-single-product' );
	} else {
		get_template_part( 'woocommerce/tm-close-wrapper' );
	}
}
